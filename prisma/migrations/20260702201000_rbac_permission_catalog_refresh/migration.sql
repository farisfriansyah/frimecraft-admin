-- Refresh RBAC permission catalog (idempotent)
INSERT INTO "permissions" ("name", "description") VALUES
  ...
  ('certification.manage', 'Izin mengelola data sertifikasi'),
...
-- ADMIN permission set (add missing grants)
INSERT INTO "_RolePermissions" ("A", "B")
SELECT p."id", r."id"
FROM "permissions" p
...
-- EDITOR permission set (add missing grants)
INSERT INTO "_RolePermissions" ("A", "B")
SELECT p."id", r."id"
FROM "permissions" p
...
-- Backfill granular permissions to roles that previously had experience.manage
INSERT INTO "_RolePermissions" ("A", "B")
...
-- Enforce admin@frimecraft.com as SUPER ADMIN
UPDATE "users"
